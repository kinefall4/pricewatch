...
payload = {
    ...
    "latest_prices": [{"item": r.item, "price": float(r.price)} for r in latest.itertuples()],
    "top_movers": [{"item": r.item, "pct_change": float(r.pct_change), "price": float(r.price)} for r in movers.itertuples()],
}
